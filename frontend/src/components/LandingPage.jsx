    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-indigo-600/30 selection:text-indigo-200">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          {/* Desktop Navigation Links (Removed Solutions & Pricing) */}
          <nav className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-300">
            <a href="#overview" className="hover:text-indigo-400 transition-colors">Overview</a>
            <a href="#features" className="hover:text-indigo-400 transition-colors">Features</a>
            <a href="#download" className="hover:text-indigo-400 transition-colors">Resources</a>
          </nav>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button
              onClick={() => onNavigate('auth')}
              className="bg-indigo-600 hover:bg-indigo-500 active:scale-95 transition-all text-white text-sm font-semibold px-4 py-2 rounded-xl shadow-lg shadow-indigo-600/10"
            >
              Try for free
            </button>
          </div>
        ...
        {/* Mobile Dropdown Menu (Removed Solutions & Pricing) */}
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-slate-800 bg-slate-950 px-4 py-4 space-y-3 shadow-xl">
            ...
            <div className="flex flex-col gap-2.5 pt-2">
              ...
              <button
                onClick={() => { setIsMobileMenuOpen(false); onNavigate('auth'); }}
                className="w-full text-center bg-indigo-600 hover:bg-indigo-500 text-sm font-semibold text-white py-2 rounded-xl"
              >
                Try for free
              </button>
            </div>
      ...
      <section id="overview" className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        {/* Glow Effects */}
        <div className="absolute top-24 left-1/4 w-96 h-96 bg-indigo-600/10 rounded-full blur-3xl -z-10"></div>
        <div className="absolute bottom-24 right-1/4 w-96 h-96 bg-purple-600/10 rounded-full blur-3xl -z-10"></div>

        {/* Hero Left Content */}
        <div className="flex-1 text-center lg:text-left space-y-6">
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 select-none">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight">
            ...
            <span className="text-indigo-500 font-black">Z</span>
            <br />
            <span className="text-slate-200">Real-Time Workspace</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
            <button
              onClick={() => onNavigate('auth')}
              className="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-500 active:scale-95 transition-all text-white text-sm font-bold px-8 py-4 rounded-xl shadow-lg shadow-indigo-600/20 flex items-center justify-center gap-2"
            >
              Start for Free
            ...
            <button
              onClick={() => onNavigate('auth')}
              className="w-full sm:w-auto bg-slate-900 hover:bg-slate-800 text-slate-200 hover:text-white border border-slate-800 text-sm font-bold px-8 py-4 rounded-xl active:scale-95 transition-all"
            >
          ...
          {/* Social Proof Badges */}
          <div className="pt-8 border-t border-slate-900 flex flex-wrap justify-center lg:justify-start items-center gap-6 text-[11px] font-bold uppercase tracking-wider text-slate-500 select-none">
        ...
        {/* Hero Right: Professional SaaS Dashboard Mockup Preview */}
        <div className="flex-1 w-full max-w-xl lg:max-w-none relative aspect-[4/3] rounded-2xl bg-slate-900/95 border border-slate-800 shadow-2xl flex flex-col justify-between overflow-hidden backdrop-blur-md">
          
          {/* Mockup Header Toolbar */}
          <div className="h-10 border-b border-slate-850 bg-slate-950/70 flex items-center justify-between px-4 select-none">
            <div className="flex items-center gap-1.5">
              <span className="w-2.5 h-2.5 rounded-full bg-rose-500/80"></span>
              <span className="w-2.5 h-2.5 rounded-full bg-amber-500/80"></span>
              <span className="w-2.5 h-2.5 rounded-full bg-emerald-500/80"></span>
            </div>
            <div className="bg-slate-900 text-slate-500 text-[9px] px-6 py-1 rounded-md font-mono">
          ...
          <div className="flex-1 flex overflow-hidden">
            ...
            {/* Left Zone: Whiteboard Canvas with Grid and Flowchart */}
            <div className="flex-1 bg-slate-900/30 relative p-4 flex flex-col justify-center items-center">
              ...
              <svg viewBox="0 0 260 160" className="w-full h-full opacity-90 z-10">
                ...
                {/* Nodes */}
                <rect x="15" y="25" width="65" height="26" rx="5" fill="#6366f1" fillOpacity="0.1" stroke="#6366f1" strokeWidth="1.2" />
                <text x="25" y="41" fill="#818cf8" fontSize="8" fontWeight="bold">API Router</text>

                <rect x="110" y="25" width="65" height="26" rx="5" fill="#a855f7" fillOpacity="0.1" stroke="#a855f7" strokeWidth="1.2" />
                <text x="123" y="41" fill="#c084fc" fontSize="8" fontWeight="bold">Auth Pod</text>
              ...
              {/* Glowing cursor mock */}
              <div className="absolute top-1/4 left-1/3 flex items-center gap-1 bg-indigo-600/90 text-white text-[8px] font-bold px-1.5 py-0.5 rounded shadow-lg animate-bounce select-none">
            ...
            <div className="w-36 border-l border-slate-850 bg-slate-950/40 p-2.5 flex flex-col gap-2.5 select-none">
              ...
              <div className="p-1.5 rounded bg-slate-900 border border-slate-800/80 flex items-center justify-between gap-1.5">
                <div className="flex items-center gap-1.5">
                  <div className="w-5 h-5 rounded bg-pink-500/10 border border-pink-500/25 flex items-center justify-center font-extrabold text-[9px] text-pink-400">
                    SJ
                  </div>
                  <span className="text-[9px] font-bold text-slate-300">Sarah J.</span>
                </div>
              ...
              <div className="p-1.5 rounded bg-slate-900 border border-slate-800/80 flex items-center justify-between gap-1.5">
                <div className="flex items-center gap-1.5">
                  <div className="w-5 h-5 rounded bg-emerald-500/10 border border-emerald-500/25 flex items-center justify-center font-extrabold text-[9px] text-emerald-400">
                    AR
                  </div>
                  <span className="text-[9px] font-bold text-slate-300">Alex R.</span>
                </div>
                {/* Muted indicator */}
              ...
              <div className="mt-auto aspect-video rounded bg-slate-900 border border-slate-800 overflow-hidden relative flex items-center justify-center">
                <div className="absolute inset-0 bg-gradient-to-tr from-slate-900 via-indigo-950/20 to-slate-900/10 flex items-center justify-center">
                  <div className="w-4 h-4 rounded-full bg-indigo-500/20 animate-ping absolute"></div>
                  <div className="w-4 h-4 rounded bg-indigo-500/10 border border-indigo-500/25 flex items-center justify-center font-bold text-[8px] text-indigo-400">
                    Y
                  </div>
                </div>
                <span className="absolute bottom-1 left-1 text-[7px] text-slate-500 bg-slate-950/80 px-1 rounded">
                  You
                </span>
              </div>
          ...
          <div className="h-6 px-4 bg-slate-950/90 border-t border-slate-850 flex items-center justify-between text-[8px] font-mono text-slate-500 select-none">
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-slate-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12">
          {/* Feature 1 */}
          <div className="bg-slate-900/30 border border-slate-800/50 rounded-2xl p-6 hover:border-indigo-500/25 transition-all">
            <div className="w-10 h-10 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center mb-5 text-indigo-400">
          ...
          {/* Feature 3 */}
          <div className="bg-slate-900/30 border border-slate-800/50 rounded-2xl p-6 hover:border-indigo-500/25 transition-all">
            <div className="w-10 h-10 rounded-xl bg-pink-500/10 border border-pink-500/20 flex items-center justify-center mb-5 text-pink-400">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
      ...
      <section id="download" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-slate-900">
        <div className="relative rounded-3xl bg-slate-900/25 border border-slate-800/80 p-8 sm:p-12 overflow-hidden flex flex-col md:flex-row items-center gap-10 md:gap-12">
          ...
          <div className="flex-1 text-center md:text-left space-y-5">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 pt-3 select-none">
              ...
              <a
                ...
                className="bg-black hover:bg-slate-955 text-white border border-slate-800 rounded-xl px-4 py-2.5 flex items-center gap-3 transition-colors max-w-[170px]"
              >
      ...
      {/* --- Footer Section --- */}
      <footer className="bg-slate-950 border-t border-slate-900 py-8 text-center text-[10px] text-slate-500 select-none">
